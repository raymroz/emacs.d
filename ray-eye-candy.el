...
(defun ray/decrease-font-size ()
  ...
  (set-face-attribute 'default
                      ...
                      (floor (* 0.9
                                  (face-attribute 'default :height)))))
(global-set-key (kbd "C-+") 'ray/increase-font-size)
(global-set-key (kbd "C--") 'ray/decrease-font-size)
